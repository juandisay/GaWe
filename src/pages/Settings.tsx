                    ...
                    <CardHeader>
                        <div className="flex items-center gap-3 mb-2">
                             ...
                             <div>
                                ...
                                <CardDescription>Get notified when you lose focus</CardDescription>
                             </div>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="flex items-center justify-between p-4 rounded-xl bg-surface border border-white/5">
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Remind me if I'm inactive during a focus session</p>
                            </div>
                            <Switch 
                                checked={settings.activityMonitoring} 
                                onCheckedChange={(checked) => settings.setActivityMonitoring(checked)} 
                            />
                        </div>
                        ...
                        {settings.activityMonitoring && (
                            <div className="space-y-3 p-4">
                                <div className="flex justify-between">
                                    <label className="block font-medium text-sm text-gray-300">Inactivity Threshold</label>
                                    <span className="text-sm text-blue-400 font-medium">{Math.floor(settings.activityThreshold / 60)} minutes</span>
                                </div>
                                <input 
                                    type="range" 
                                    min="60" 
                                    ...
                                    onChange={(e) => settings.setActivityThreshold(Number(e.target.value))}
                    ...
                    <CardHeader>
                         <div className="flex items-center gap-3 mb-2">
                             ...
                             <div>
                                ...
                                <CardDescription>Immersive audio for your sessions</CardDescription>
                             </div>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="flex items-center justify-between p-4 rounded-xl bg-surface border border-white/5">
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Automatically play music when a session starts</p>
                            </div>
                            <Switch 
                                checked={settings.musicAutoPlay} 
                                onCheckedChange={(checked) => settings.setMusicAutoPlay(checked)} 
                            />
                        </div>

                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-400 mb-2">Music File</label>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    />
                                    <span className="w-12 text-right text-gray-300 font-mono">{Math.round(settings.musicVolume * 100)}%</span>
                                </div>
                            </div>
                        </div>
                    </CardContent>
